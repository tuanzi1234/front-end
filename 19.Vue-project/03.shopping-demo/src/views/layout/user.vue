<template>
  <div class="user">
    ...
    <div class="order-navbar">
      <div class="order-navbar-item" @click="goToOrder('all')">
        <van-icon name="balance-list-o" />
        <span>全部订单</span>
      </div>
      <div class="order-navbar-item" @click="goToOrder('payment')">
        <van-icon name="clock-o" />
        <span>待支付</span>
      </div>
      <div class="order-navbar-item" @click="goToOrder('delivery')">
        <van-icon name="logistics" />
        <span>待发货</span>
      </div>
      <div class="order-navbar-item" @click="goToOrder('received')">
  ...
  methods: {
    ...
    goToOrder (dataType) {
      ...
      if (this.$store.getters.token) {
        // 已登录，直接跳转
        this.$router.push(`/myorder?dataType=${dataType}`)
      } else {
        // 未登录，先跳转到登录页
        this.$router.push('/login')
      }
